...
public class SkinChangeCooldownStorage implements Runnable {
    ...
    public static int getCooldown(String name) {
        int int1 = Integer.valueOf(String.format("%d",
                TimeUnit.MILLISECONDS.toMinutes(cooldown.get(name))));
    ...
    public void run() {
        ...
        Iterator<Long> iterator = SkinChangeCooldownStorage.cooldown.values().iterator();
