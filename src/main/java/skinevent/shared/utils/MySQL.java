    ...
    public void closeConnection() {
        if (isConnected())
            try {
                ...
                System.out.println("[SkinEvent] MySQL error: " + e.getMessage());
            }
    }
                ...
                public void run() {
                    try {
                        con = DriverManager.getConnection("jdbc:mysql://" + host + ":" + port + "/" + database + "?verifyServerCertificate=false&useSSL=false",
                                username, password);
                        System.out.println("[SkinEvent] Connected to MySQL!");
                        createTable();
                    } catch (SQLException e) {
                        System.out.println("[SkinEvent] Could NOT connect to MySQL: " + e.getMessage());
                    }
                }
