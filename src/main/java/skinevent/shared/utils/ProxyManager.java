...
public class ProxyManager {
    ...
    public static List<String> getList() {
        if (proxies.isEmpty()) {
            System.out.print("[SkinEvent] Proxy list is empty. Getting one.");
    ...
    public static List<String> updateProxies() {
        ...
        try {
            ...
            System.out.print("[SkinEvent] We couldn't update the proxy list. This usually indicates a firewall problem. A detailed error is below.");
            e.printStackTrace();
        }
        return proxies;
    }
